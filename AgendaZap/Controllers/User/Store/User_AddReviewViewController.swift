//
//  User_AddReviewViewController.swift
//  AgendaZap
//
...
class User_AddReviewViewController: UIViewController, UIScrollViewDelegate, UITextFieldDelegate, UIGestureRecognizerDelegate
{
    // MARK: - IBOutlet
...
//    }
    ...
    func setupInitialView()
    {
        ...
        txtViewMyReviewContainerView?.backgroundColor = MySingleton.sharedManager().themeGlobalWhiteColor
